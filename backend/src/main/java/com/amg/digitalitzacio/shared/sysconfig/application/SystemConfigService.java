...
public class SystemConfigService {
    ...
    public static final List<KnownKey> KNOWN_KEYS = List.of(
        ...
        new KnownKey("INFRAOPS_DISABLED_RECS",  "InfraOps — recomanacions desactivades", "Tipus de recomanació d'escalat que NO s'han de generar (separats per coma). Ex: SEPARATE_N8N. Tipus: UPGRADE_CPU, UPGRADE_RAM, UPGRADE_DISK, SEPARATE_DB, SEPARATE_N8N, MIGRATE_HETZNER_CLOUD.", "GENERAL", false, "string", null, null, 200),
