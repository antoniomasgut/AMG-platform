...
public class SystemConfigService {
    ...
    public static final List<KnownKey> KNOWN_KEYS = List.of(
        ...
        new KnownKey("WHATSAPP_META_COST_EUR_MICROS",   "WhatsApp Meta — cost/missatge (micros €)",   "Cost per missatge sortint via Meta Cloud API (tarifa conversació). Default: 50000 = €0.05", "AGENTS", false, "number", "50000", "{\"min\":1000,\"max\":200000}", 120),
