    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/sites/serve/**").permitAll()
                        ...
                        // Swagger / OpenAPI: només SUPER_ADMIN i ADMIN
                        .requestMatchers("/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html").hasAnyRole("SUPER_ADMIN", "ADMIN")
                        ...
                        // Fitxa de configuració i estat de projecte públics (accés per token, sense autenticació)
