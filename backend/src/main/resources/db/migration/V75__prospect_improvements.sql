...
ALTER TABLE prospect_campaigns
    ...
    ADD COLUMN IF NOT EXISTS followup_days1 INTEGER DEFAULT 3,
    ADD COLUMN IF NOT EXISTS followup_days2 INTEGER DEFAULT 7,
    ADD COLUMN IF NOT EXISTS followup_days3 INTEGER DEFAULT 14;
