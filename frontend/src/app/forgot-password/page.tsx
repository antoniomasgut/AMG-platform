        ...
        <div className="amg-card card-clip p-6 sm:p-8">
          ...
          {sent ? (
            <>
              ...
              <p className="text-[13px] text-[#94a3b8] mt-2 text-center">
                Si el correu existeix, rebràs un enllaç de recuperació a
              </p>
              <div className="f-mono text-sm text-[#FF9A3C] text-center mt-1">{email}</div>
              ...
              <div className="mt-6 p-3 border-l-2 border-l-[#58a6ff] bg-[rgba(88,166,255,0.05)] flex gap-3">
                ...
                <div className="text-[12px] text-[#94a3b8]">
                  L&apos;enllaç caduca en <span className="text-[#58a6ff] f-mono">30 min</span>.
              ...
              <Link
                href="/login"
                className="mt-6 block w-full text-center f-mono text-[11px] uppercase text-[#64748b] hover:text-[#FF9A3C] transition"
              >
                ← TORNAR AL LOGIN
              </Link>
            </>
            ...
            <>
              ...
              <Link
                href="/login"
                className="mt-4 block w-full text-center f-mono text-[11px] uppercase text-[#64748b] hover:text-[#FF9A3C] transition"
              >
                ← TORNAR AL LOGIN
              </Link>
            </>
