...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'verticals.pressupostos' });
  ...
  return {
    ...
    alternates: {
      canonical: `${siteUrl}/${locale}/pressupostos`,
      languages: Object.fromEntries(routing.locales.map(l => [l, `${siteUrl}/${l}/pressupostos`])),
    },
    openGraph: {
      title: t('meta.title'),
      description: t('meta.description'),
      url: `${siteUrl}/${locale}/pressupostos`,
...
export default async function Pressupostos({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
